 ...
 * @author Venette
 */
@ManagedBean(name = "bajasPendtsBean")
@ViewScoped
public class BajasPendientesBean extends BaseBean implements Serializable {

    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(BajasPendientesBean.class);
    ...
    public BajasPendientesBean() {
        this.bo = new HistorialBajasBo();
    }

    public void init() {
        try {
            bajas = bo.getBajaUsuarios(Constantes.BAJA_PENDIENTE);
