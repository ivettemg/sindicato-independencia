 ...
 * @author Venette
 */
@ManagedBean(name = "valsolCredHistorial")
@ViewScoped
public class ValSolCreditosHistorialBean extends BaseBean implements Serializable{
    
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(ValSolCreditosHistorialBean.class);
    ...
    public ValSolCreditosHistorialBean() {
